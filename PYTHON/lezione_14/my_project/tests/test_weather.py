...
def test_check_weather3():
    assert check_weather(5.00) == "cold", 'temperatures lower then 10 degree must be considered as cold'
...
def test_check_weather5():
    assert check_weather(30.00) == "hot",'temperatures geated than 20 degree must be considered as hot'
